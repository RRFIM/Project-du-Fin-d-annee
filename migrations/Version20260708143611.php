...
final class Version20260708143611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, meta_description VARCHAR(255), download_rate INTEGER, is_approved BOOLEAN, online_game_url VARCHAR(255), source_code_url VARCHAR(255), browser_version VARCHAR(255), requirements VARCHAR(255), nb_player_max INTEGER, submitter_id INTEGER NOT NULL, uploads_id INTEGER, CONSTRAINT FK_232B318C919E5513 FOREIGN KEY (submitter_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CB66372A5 FOREIGN KEY (uploads_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
